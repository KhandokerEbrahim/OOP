...
struct Distance { double feet; double inches; char dumycar; }; int n,i; struct Room { Distance length; Distance width; }R[1000];
...
} int main() { cout <<"ENTER NUMBER OF ROOM"<<endl; cin >>n;
